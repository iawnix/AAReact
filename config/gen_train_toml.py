...
def touch_toml(out_fp: str,
    ...
    with open(out_fp, "w+") as F:
        ...
        F.writelines("model_save = \"/home/iaw/DATA/AAReact/train/output/pt/{}_{}_seed_0-1_test_0-2.pkl\"\n".format(model_name, desc_type))
        F.writelines("cv = 5\n")
...
for i_m in model_s:
    for i_c in comb_s:
        ...
        log_f = "/home/iaw/DATA/AAReact/train/output/hyper_log/{}_{}_seed_0-1_test_0-2_cv_5_hyper.log".format(i_m, i_desc_type)
        hyper_params = read_hyper_log(log_f)
        touch_toml(
              out_fp = "/home/iaw/DATA/AAReact/config/train_ml_{}_{}.toml".format(i_m, i_desc_type)
